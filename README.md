...
## Description:
  Employee Directory is a React.js application for users to store employee information and be able to search for employees by name.
![screenshot](directory.jpg)
  ## Installation Instructions:
  
  1. Download [repository](https://github.com/heathernev88/employee-directory)

	Git clone https://github.com/heathernev88/Employee-Directory
